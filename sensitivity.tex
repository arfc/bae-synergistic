...
Figure \ref{fig:ext_all} shows that lifetime extension increases
\emph{average} monthly reprocessing demand, because more \gls{LWR}
\gls{UNF} is reprocessed with delayed \gls{ASTRID} deployment.
...
\begin{table}[h]
	...
	\begin{tabular}{lrrrr}
		...
		\hline
		Total reprocessing demand & 0.0 & 0.3 & 1.7 & 5.9 \\
